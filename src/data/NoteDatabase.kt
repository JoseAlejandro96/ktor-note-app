...
import com.josh.security.checkHashForPassword
...
suspend fun deleteNoteForUser(email: String, noteID: String): Boolean{
    ...
    note?.let { note->
        if (note.owners.size > 1){
            /**
             * The note have multiple owners, so just delete the email from
             * the owners list
             */
        ...
        /**
         * Owners size only have one owner, then just delete the note
         */
